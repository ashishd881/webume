...
function Home() {
  ...
  return (
    <form>
        ...
        <input type='text' value={userPrompt} onChange={(e)=>setUserPrompt(e.target.value)} placeholder='write your promt here..' className='border-2 outline-none pl-2 rounded-3xl h-10 w-100'/>
